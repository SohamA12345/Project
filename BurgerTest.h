...
private:
    ...
    void test_Burger_case2() {
        ...
        if (b2.get_ingredient(0).get_price() != 1) {
            cout << "test 2 for burger ingredient 1 price failed, result unexpected" << endl;
        }
        if (b2.calculate_item_price() != (3.3*1.25+1)) {
            cout << "test 2 for burger item price calculation failed, result unexpected" << endl;
        }
    }
    ...
    void test_Burger_case3() {
        ...
        if (b3.get_ingredient(0).get_name() != "i1") {
            cout << "test 3 for burger ingredient 1 name failed, result unexpected" << endl;
        }
        if (b3.get_ingredient(0).get_price() != 1) {
            cout << "test 3 for burger ingredient 1 price failed, result unexpected" << endl;
        }
        if (b3.get_ingredient(1).get_name() != "i2") {
            cout << "test 3 for burger ingredient 2 name failed, result unexpected" << endl;
        }
        if (b3.get_ingredient(1).get_price() != 2) {
            cout << "test 3 for burger ingredient 2 price failed, result unexpected" << endl;
        }
        if (b3.get_ingredient(2).get_name() != "i3") {
            cout << "test 3 for burger ingredient 3 name failed, result unexpected" << endl;
        }
        if (b3.get_ingredient(2).get_price() != 3) {
            cout << "test 3 for burger ingredient 3 price failed, result unexpected" << endl;
        }
        if (b3.calculate_item_price() != (5.5*1.5+1+2+3)) {
            cout << "test 3 for burger item price calculation failed, result unexpected" << endl;
        }
    }
