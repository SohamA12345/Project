...
void CustomerLogin::run(int& state_portal) {
    ...
    switch (customer_choice) {
        case 1: {
            ...
            if (!username_found) {
                cout << "Login failed. No matching username found, please create a new account\n";
            ...
            if (i_passwords_file.is_open()) {
                for (int i = 0; i < line_number; i++) {
                    getline(i_passwords_file, read_line);  // Reads the line in password associated with the username.
                }
            ...
            if (read_line == password) {
                ...
                cout << "Login failed. No matching password found, please create a new account\n";
                cout << "Press enter to return to previous options.";
                cin.get();
                state_customer_login = 1;
                return;
        ...
        case 2: {
            ...
            if (o_passwords_file.is_open()) {
                ...
                account_created.add("Back to login", 1, "Please login to access the exclusive menu.");
